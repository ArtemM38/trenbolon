    ...
    <article class="flex gap-5 max-md:flex-col">
      <section class="w-[56%] max-md:ml-0 max-md:w-full flex">
        ...
        <div class="w-full mr-4">
          <img
            src="https://i.ibb.co/tPJXjBfD/smallpr-21941-3.png"
        ...
        <div class="small-images w-[30%]">
          ...
          />
          <img
            src="https://i.ibb.co/YC5YhTF/smallpr-21941-2.png"
            class="small-image rounded-md"
            onclick="changeMainImage(this.src)"
          />
          <img
            src="https://i.ibb.co/N5kDsxN/pr-21941-1.png"
            class="small-image rounded-md"
            onclick="changeMainImage(this.src)"
          />
        </div>
        ...
        <div class="w-full max-md:mt-10">
          ...
          <div class="flex gap-1.5 mt-2.5">
            ...
            <div class="flex flex-col grow shrink-0 text-white basis-0 w-fit">
              ...
              Кофта с капюшоном Sitka Traverse Hoody.
Ткань из полиэстера с подкладкой из берберского флиса с высоким ворсом.
Экологичная ткань из переработанных материалов.
Флисовые вставки средней плотности по бокам и в области подмышек для оптимального комфорта и свободы движений.
Прочная водоотталкивающая пропитка защищает от небольших осадков и предотвращает намокание ткани.
              </p>
