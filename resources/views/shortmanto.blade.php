    ...
    <article class="flex gap-5 max-md:flex-col">
      <section class="w-[56%] max-md:ml-0 max-md:w-full flex">
        ...
        <div class="small-images w-[30%]">
          ...
          />
          <img
            src="https://i.ibb.co/s9wHCFT6/pr-21558-2.png"
            class="small-image rounded-md"
            onclick="changeMainImage(this.src)"
          />
          <img
            src="https://i.ibb.co/WNZ8JHhP/pr-21558-3.png"
            class="small-image rounded-md"
            onclick="changeMainImage(this.src)"
          />
        </div>
        ...
        <div class="w-full max-md:mt-10">
          ...
          <div class="flex gap-1.5 mt-2.5">
            <div class="flex flex-col items-start">
              ...
              <p class="self-stretch mt-24 text-3xl font-bold text-white max-md:mt-10">3990р</p>
            </div>

            <div class="flex flex-col grow shrink-0 text-white basis-0 w-fit">
              <p class="text-sm leading-5">
              Мужские шорты S/Lab Sense 6, разработанные спортсменами и для спортсменов, — удачный выбор для активных тренировок.
              <br />
                Внутренние шорты из материала с технологией 37.5 эффективно отводят влагу и излишки тепла.
                <br />
                Вместительный сетчатый пояс-карман для важных мелочей.
                <br />
                Тянущаяся в 4 направлениях ткань и прямой крой для свободы движений.
