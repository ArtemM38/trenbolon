    ...
    <article class="flex gap-5 max-md:flex-col">
      <section class="w-[56%] max-md:ml-0 max-md:w-full flex">
        ...
        <div class="w-full mr-4">
          <img
            src="https://i.ibb.co/zWFg80MV/salomon-2-no-bg-preview-carve-photos.png"
        ...
        <div class="small-images w-[30%]">
          ...
          />
          <img
            src="https://i.ibb.co/rGD2TfDs/3-no-bg-preview-carve-photos.png"
            alt="Кроссовки salomon мужские - вид 2"
            class="small-image rounded-md"
            onclick="changeMainImage(this.src)"
          />
          <img
            src="https://i.ibb.co/gbYZnt1X/4-no-bg-preview-carve-photos.png"
        ...
        <div class="w-full max-md:mt-10">
          ...
          <div class="flex gap-1.5 mt-2.5">
            <div class="flex flex-col items-start">
              ...
              <p class="self-stretch mt-24 text-3xl font-bold text-white max-md:mt-10">8700р</p>
            </div>

            <div class="flex flex-col grow shrink-0 text-white basis-0 w-fit">
              <p class="text-sm leading-5">
              Система пластиковых «крыльев» по бокам верха обуви. Поддерживает стопу,
