...
>
  ...
  <nav class="nav-link3 flex flex-wrap gap-5 justify-between mt-8 max-w-full text-xl text-white">
            <div class="flex gap-10 items-center max-md:max-w-full">
                ...
                <a href="/map" class="first-link2">Контакты</a>
                <a href="/katalog" class="nav-link2">Каталог</a>
                <a href="/cart" class="nav-link2">Корзина</a>
            </div>
  ...
  <main  class="flex flex-col items-start self-start mt-20 ml-96 font-semibold max-md:mt-10 max-md:ml-2.5" >
    <section class="self-stretch">
      <p>ФИО: Михальченко Артём Евгеньевич</p>
