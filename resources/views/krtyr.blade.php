    ...
    <article class="flex gap-5 max-md:flex-col">
      <section class="w-[56%] max-md:ml-0 max-md:w-full flex">
        ...
        <div class="w-full mr-4">
          <img
            src="https://i.ibb.co/N26qBysV/pr-22721-1.png"
            alt="Кроссовки salomon мужские"
        ...
        <div class="small-images w-[30%]">
          <img
            src="https://i.ibb.co/N26qBysV/pr-22721-1.png"
            alt="Кроссовки salomon мужские - вид 1"
            class="small-image rounded-md"
            onclick="changeMainImage(this.src)"
          />
          <img
            src="https://i.ibb.co/qMf1KJvZ/pr-22721-2.png"
            alt="Кроссовки salomon мужские - вид 2"
            class="small-image rounded-md"
            onclick="changeMainImage(this.src)"
          />
          <img
            src="https://i.ibb.co/NwfT6pQ/pr-22721-3.png"
            alt="Кроссовки salomon мужские - вид 3"
            class="small-image rounded-md"
            onclick="changeMainImage(this.src)"
          />
        </div>
          ...
          <div class="flex gap-1.5 mt-2.5">
            <div class="flex flex-col items-start">
              ...
              <div class="size-column mt-3">
                <button class="size-option px-3 py-1 text-sm border text-white border-neutral-600 rounded-md" onclick="selectSize(this)">40</button>
                <button class="size-option px-3 py-1 text-sm border text-white border-neutral-600 rounded-md selected" onclick="selectSize(this)">41</button>
                <button class="size-option px-3 py-1 text-sm border text-white border-neutral-600 rounded-md" onclick="selectSize(this)">42</button>
                <button class="size-option px-3 py-1 text-sm border text-white border-neutral-600 rounded-md" onclick="selectSize(this)">43</button>
                <button class="size-option px-3 py-1 text-sm border text-white border-neutral-600 rounded-md" onclick="selectSize(this)">44</button>
              </div>

              <p class="self-stretch mt-24 text-3xl font-bold text-white max-md:mt-10">12000р</p>
            </div>

            <div class="flex flex-col grow shrink-0 text-white basis-0 w-fit">
              <p class="text-sm leading-5">
             Кроссовки для фитнеса Tyr Turf Trainer 544.
В кроссфите очень важно иметь качественную и удобную обувь, которая бы обеспечивала комфорт и безопасность во время самых сложных упражнений.
Кроссовки Tyr Turf Trainer разработаны специально для функциональных тренировок и кроссфита (и в зале, и на улице).
