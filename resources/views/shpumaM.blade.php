    ...
    <article class="flex gap-5 max-md:flex-col">
      <section class="w-[56%] max-md:ml-0 max-md:w-full flex">
        ...
        <div class="small-images w-[30%]">
          ...
          />
          <img
            src="https://i.ibb.co/3Yfsj9GV/8c188a8a736fb1afba91643d553f0953-no-bg-preview-carve-photos.png"
            class="small-image rounded-md"
            onclick="changeMainImage(this.src)"
          />
          <img
            src="https://i.ibb.co/xSHb5SWX/2025-05-04-102116.png"
            class="small-image rounded-md"
            onclick="changeMainImage(this.src)"
          />
        </div>
        ...
        <div class="w-full max-md:mt-10">
          ...
          <div class="flex gap-1.5 mt-2.5">
            <div class="flex flex-col items-start">
              ...
              <p class="self-stretch mt-24 text-3xl font-bold text-white max-md:mt-10">3200р</p>
            </div>

            <div class="flex flex-col grow shrink-0 text-white basis-0 w-fit">
              <p class="text-sm leading-5">
              Шорты puma помогут вам достичь наилучших результатов. 
              Шорты оснащены технологией отвода влаги, чтобы вы оставались сухими,
              имеют светоотражающую графику для повышения безопасности и 
              сетчатую вставку для улучшения воздухопроницаемости.
              </p>
              <form action="{{ route('cart.add', ['product' => $product->id ?? 1]) }}" method="POST" class="mt-10 sm:mt-12">
                @csrf
                <div class="flex flex-wrap items-center gap-6 sm:gap-8">
                    <div class="font-rubik-semibold text-4xl sm:text-5xl text-white">3200 ₽</div>
